let db,paging,myPageSearch;_6c1‍.x([["myQnaIndex",()=>myQnaIndex],["myQnaSearch",()=>myQnaSearch],["myQnaView",()=>myQnaView],["myQnaEditIndex",()=>myQnaEditIndex],["myQnaEdit",()=>myQnaEdit],["myQnaDelete",()=>myQnaDelete]]);_6c1‍.w("../../../models",[["db",["db"],function(v){db=v}]]);_6c1‍.w("../../../utils/pagination",[["paging",["paging"],function(v){paging=v}]]);_6c1‍.w("../../../utils/search",[["myPageSearch",["myPageSearch"],function(v){myPageSearch=v}]]);
 ...
 */
  ...
  try {
    ...
    _6c1‍.g.console.log(e)
    ctx.throw(500, e);
  };
};

       const myQnaView = async ctx => {
  try {
    ...
    ctx.throw(500, e);
       ...
       const myQnaEditIndex = async ctx => {
  try {
