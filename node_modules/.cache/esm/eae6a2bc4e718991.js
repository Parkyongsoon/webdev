let bcrypt,jwt,crypto,Joi,dotenv,db,registerValidator,loginValidator;_4e7‍.x([["registerIndex",()=>registerIndex],["register",()=>register],["checkId",()=>checkId],["login",()=>login],["logout",()=>logout]]);_4e7‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_4e7‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_4e7‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_4e7‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);_4e7‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_4e7‍.w("../../../models",[["db",["db"],function(v){db=v}]]);_4e7‍.w("../../../utils/validator",[["registerValidator",["registerValidator"],function(v){registerValidator=v}],["loginValidator",["loginValidator"],function(v){loginValidator=v}]]);
 ...
 */
  ...
  try {
    ...
    if(result.error) {
     ...
     // ctx.status = 400;
     // ctx.body = error;
     _4e7‍.g.console.log(result.error.details);
     ctx.status = 400;
     await ctx.render('admin/auth/register', {
       username,
       password,
