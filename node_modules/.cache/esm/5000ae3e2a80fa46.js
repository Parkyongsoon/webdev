let db;_2a8‍.x([["myPaymentPending",()=>myPaymentPending],["myPaymentConfirm",()=>myPaymentConfirm]]);_2a8‍.w("../../../models",[["db",["db"],function(v){db=v}]]);

/**
 * myPageMyPaymentCtrl
 */

       const myPaymentPending = async ctx => {
  try {
    ...
    ctx.throw(500, e);
       ...
       const myPaymentConfirm = async ctx => {
  try {
